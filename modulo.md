...
class SaleOrderLine(models.Model):
    ...
    residue_capacity = fields.Float(
        string="Capacidad (L)",
        help="Capacidad del contenedor en litros"
    )
...
Capacidad: {self.residue_capacity} L
    ...
    <template id="report_saleorder_document_custom" inherit_id="sale.report_saleorder_document">
        ...
        <xpath expr="//td[@name='td_quantity']" position="replace">
            <td name="td_quantity" class="text-end text-nowrap">
                ...
                <span t-if="line.product_packaging_id" t-field="line.product_packaging_id.name">TOTE</span>
                <span t-else="" t-field="line.product_uom.name">units</span>
            </td>
        </xpath>
        
        <!-- OCULTAR campos sensibles en las líneas del reporte (plan_manejo y residue_type) -->
        <!-- Estos campos NO deben aparecer en el reporte impreso para el cliente -->
        <xpath expr="//td[@name='td_name']//span[@t-field='line.name']" position="after">
            <!-- Asegurarnos que no se muestren campos internos en la descripción -->
...
<odoo>
  <record id="view_sale_order_form_crm_fields" model="ir.ui.view">
    ...
    <field name="arch" type="xml">
      ...
      <!-- 4) Tree: modificar columnas en las líneas - AGREGANDO CAPACIDAD -->
      <xpath expr="//page[@name='order_lines']//list/field[@name='product_template_id']" position="replace">
        ...
        <field name="plan_manejo" string="Plan de Manejo" optional="show"/>
        
        <!-- NUEVO: Campo de capacidad -->
        <field name="residue_capacity" string="Capacidad (L)"/>
        
        <!-- CAMPOS DE PESO Y UNIDADES -->
        ...
        <!-- Campo de embalaje -->
        <field name="residue_packaging_id" string="Embalaje"/>
        
        <!-- Campo de UoM (siempre debe mostrar "Unidades") -->
        <field name="residue_uom_id" string="UoM" readonly="1"/>
      ...
      <xpath expr="//page[@name='order_lines']//form//field[@name='product_id']" position="after">
        ...
        <!-- Información de cantidades, capacidad, peso y embalaje - SIEMPRE EDITABLE -->
        <group string="Cantidades, Capacidad, Peso y Embalaje">
          <field name="residue_capacity" string="Capacidad (L)" placeholder="Ejemplo: 200"/>
